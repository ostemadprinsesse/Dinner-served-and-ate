...
db.prepare("INSERT OR IGNORE INTO ingredients VALUES (NULL, ?, ?, ?)").run(
  "Tomatoes",
  "kg",
  "Vegetables",
);
...
db.prepare(
  "INSERT OR IGNORE INTO recipe_ingredients VALUES (NULL, ?, ?, ?, ?)",
).run(1, 1, "400", "g"); // Tomatoes
db.prepare(
  "INSERT OR IGNORE INTO recipe_ingredients VALUES (NULL, ?, ?, ?, ?)",
).run(1, 2, "3", "cloves"); // Garlic
db.prepare(
  "INSERT OR IGNORE INTO recipe_ingredients VALUES (NULL, ?, ?, ?, ?)",
).run(1, 3, "50", "ml"); // Olive Oil
db.prepare(
  "INSERT OR IGNORE INTO recipe_ingredients VALUES (NULL, ?, ?, ?, ?)",
).run(1, 4, "400", "g"); // Pasta
db.prepare(
...
db.prepare(
  "INSERT OR IGNORE INTO recipe_ingredients VALUES (NULL, ?, ?, ?, ?)",
).run(2, 2, "5", "cloves"); // Garlic
db.prepare(
  "INSERT OR IGNORE INTO recipe_ingredients VALUES (NULL, ?, ?, ?, ?)",
).run(2, 3, "100", "ml"); // Olive Oil
